...
The boundary around *Homo sapiens* is late in the history of human capacities. Fossils from Jebel Irhoud place early members of the clade, or a population close to it, at roughly 315,000 years ago; Omo I gives a minimum age of 233,000 years for eastern Africa. By then, bipedal locomotion, stone-flake production, long-range dispersal, large-animal processing, Acheulean biface manufacture, fire use, wooden weapon production, and extended social learning already had deep histories. Bipedality and stone working reach beyond secure *Homo*. Range expansion, biface manufacture, fire practices, and organic technologies were sustained by *Homo erectus*, Neanderthal-lineage populations, Denisovans, *Homo naledi*, *Homo floresiensis*, and poorly resolved regional forms. The sapiens boundary is a taxonomic stabilization inside an older hominin field. The record has the structure of a stratigraphy: upright bodies before large brains, manipulative hands before secure species assignment, tools before modern anatomy, population networks before global replacement. The surviving species inherited this field and narrowed it by outlasting, absorbing, or replacing the other lineages. Read as a stratigraphy of dated capacities, seven of eight precede the Jebel Irhoud boundary, and the same seven precede Omo I, the deepest by more than 4 million years.
...
The taxonomic label performs useful work. It lets fossils be compared, regions sequenced, lineages named. It also encourages a false compression. The capacities later gathered under *H. sapiens* predate the moment at which the label becomes stable. The species inherited a body plan older than the genus *Homo*, a technical history older than the earliest secure *Homo* fossils, and a social ecology shaped by cooperative foraging, infant dependency, and learned extraction from difficult landscapes.
...
The phrase "before sapiens" names a substrate. Before law, myth, ritual, or explicit doctrine can make persons, organisms have to become beings for whom tools, food sharing, teaching, memory, group inheritance can accumulate. The archaeological and fossil record gives that deeper assembly in fragments.
...
The order is decisive. The upright body precedes large brains by millions of years. Human history begins in feet, pelvis, hands, habitat, long before it begins in the cortex.
...
A flake is a produced edge, obtained by controlling angle, force, material, sequence. The maker has to perceive a future cutting surface inside an unstruck core. The skill can be learned, repeated, and transmitted. The tool may be simple; the tradition exceeds a single motion. The hand learns stone through a choreography that survives across bodies.

Externalized technical inheritance appears here in a minimal but durable form. One body learns from another. One generation leaves behind cores, flakes, preferred raw materials, activity sites, failed attempts, all of which structure the next generation's learning environment. Technique becomes a social memory held partly outside any one nervous system.
...
Continental range was a technical and social achievement. Movement across Africa and Eurasia required unfamiliar prey, raw materials, seasons, predators, parasites, climates, all to be made usable. Bodies mattered; learned ecologies made range durable. A group had to know where water might be found, which stone would fracture, how carcasses could be opened, when movement was possible, how infants survived travel, and how danger was read. The pre-sapiens human was already a geographic learner.


## 5. Fire as maintenance

Fire is the most difficult major capacity to date cleanly because traces are fragile and natural burning has to be separated from controlled use. The evidence at Wonderwerk Cave in South Africa, reported by Berna and colleagues, places in situ burning inside the cave at roughly 1 million years ago. The reading as controlled rather than natural rests on the microstratigraphy: burned bone and ashed plant matter sit in undisturbed layers deep inside the cave, where wildfire and lightning do not reach. Several European and Near Eastern sites produce later and stronger evidence for repeated fire use. By the later Middle Pleistocene, fire belongs securely to hominin life in many regions.
...
Fire changes the ecology of action. It extends usable hours after sunset, pushes predators away from sleeping bodies, softens food, hardens wooden tools. It creates a place around which bodies gather after foraging ends. The day acquires a second phase, less governed by search and movement.
...
The Schoningen spears, redated in 2025 to around 200,000 years ago (Hutson et al., 2025), show that pre-sapiens hominins in Europe made carefully shaped wooden weapons. The spears are usually associated with archaic humans in the Neanderthal lineage or a closely related Middle Pleistocene population. Their preservation is exceptional because wood usually disappears. Their existence implies a larger missing inventory of organic tools: digging sticks, carrying devices, handles, shafts, traps, containers.
...
Extended childhood belongs to this same structure. Human infants are costly, slow, and dependent. The dependency is an anatomical burden and a social opportunity. Long immaturity gives a juvenile time to absorb techniques whose acquisition exceeds instinctive maturation. Cooperative breeding, food sharing, and alloparental care create the social conditions under which expensive learners can survive long enough to become useful bearers of tradition.

Social machinery is visible even where symbols are absent. Teaching leaves traditions whose stability exceeds what naive individual discovery would produce, even when it leaves no mark shaped like a word. A handaxe industry, a fire practice, a hunting weapon, and a repeated butchery sequence are records of social transmission.
...
Origin stories survive by taking one real variable and making it sovereign. Encephalization is real, and brain size changed dramatically across hominin evolution. The chronology refuses brain-first explanation. Upright walking, manipulative hands, stone technology, range expansion: all were operating before modern cranial form. Intelligence in the record is distributed across anatomy, group practice, landscape, artifact.

Species labels are indispensable and dangerous. They allow comparison, but they tempt the last surviving label to absorb the histories of the dead. A trait list assigned to *Homo sapiens* will usually contain older elements. The modern species is a holder and recombiner of inherited capacities. Treating each capacity as a sapiens invention compresses millions of years of hominin work into the last taxonomic label.
...
Replacement was the outcome of a longer process. *H. sapiens* became the only surviving hominin species, and replacement happened in many places. The genetic and archaeological record still preserves mixture, overlap, borrowing, coexistence, local disappearance. The human field narrowed late.

Later cultural categories depend on this older scaffold: bodies that carry, hands that make, groups that teach, foods that are shared, fires that are maintained, landscapes remembered across generations. The scaffold is older than the categories built on top of it.


## 10. The stratigraphy, measured

The chronological claim can be made exact. The eight capacities are those with a single securely dated first appearance in the record above: bipedal locomotion, stone-flake production, large-animal butchery, Oldowan technology, continental dispersal, the Acheulean biface, controlled fire, and wooden weapons. Capacities whose onset has no one defensible date, symbolic marking and habitual cooking among them, are left out rather than dated by guess. Taking the earliest securely dated marker of each, and the Jebel Irhoud date of 315,000 years as the sapiens boundary, seven of the eight capacities predate the boundary. Measured against the Omo I minimum of 233,000 years, seven of eight do. The one capacity that clears neither boundary is wooden weapon manufacture, whose Schoningen instance was redated in 2025 to around 200,000 years (Hutson et al., 2025), placing it inside both Jebel Irhoud and Omo I; the late date reflects the rarity of preserved wood rather than a late onset.

The leads are not marginal. Bipedal locomotion, the deepest capacity in the set, precedes the boundary by 4.085 million years. The capability set spans 4.2 million years from upright walking to shaped wooden spears, and its median member precedes the boundary by 1.885 million years. Stone-flake production at Lomekwi precedes the earliest secure *Homo*, and continental dispersal at Dmanisi precedes the boundary by close to 1.5 million years. The order is the one the opening asserted: upright bodies, then worked stone, then large-animal butchery, then range, then fire, then the species boundary, with the lone securely dated wooden weapon falling later only because wood seldom survives.

The boundary was also crowded. At least five other hominin lineages occupy the same window, from the Neanderthal-lineage population at Sima de los Huesos near 430,000 years through *Homo naledi*, the Denisovans, *Homo luzonensis*, and *Homo floresiensis*. The sapiens threshold stabilizes a field that was already populated.

The dates are point estimates drawn from the cited literature; the paper measures nothing new. The computation in `simulation/` (`uv run run_all.py`) reports only their stratigraphic relations, and writes every value to `simulation/output/results.json`.


## 11. The inheritance is older

The pre-sapiens record gives a layered inheritance. Bodies walked and carried. Hands learned stone. Groups divided carcasses, maintained fire, moved through remembered landscapes, shaped wood, tolerated dependent learners, kept fragile traditions alive across generations.

By the time *Homo sapiens* appears, the human field is already old. Several lineages had built parts of it. Some left fossils, some left tools, some left DNA, and some left only gaps where the record should be. The modern species stands late in the sequence, inheriting capacities built across other bodies and other worlds, then becoming the population in which those capacities were amplified, recombined, and driven forward after the other human lineages disappeared.
