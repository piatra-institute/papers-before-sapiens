...
The chronological claim can be made exact. Taking the earliest securely dated marker of each capacity from the works cited above, and the Jebel Irhoud date of 315,000 years as the sapiens boundary, seven of the eight capacities predate the boundary. Measured against the Omo I minimum of 233,000 years, all eight do. The one capacity that does not clear the older boundary is wooden weapon manufacture, whose securely dated instance at Schoningen falls at 300,000 years, just inside Jebel Irhoud and well before Omo I.
...
The dates are point estimates from the cited literature, not original measurements; the computation in `simulation/` reports only their stratigraphic relations, and writes every value to `simulation/output/results.json`.
