...
The taxonomic boundary around *Homo sapiens* falls late in the history of human capacities. Fossils from Jebel Irhoud place early members of the clade, or a population close to it, at about 315,000 years ago, and Omo I gives a minimum age of 233,000 years for eastern Africa. By then bipedal locomotion, stone-flake production, long-range dispersal, large-animal processing, Acheulean biface manufacture, fire use, wooden weapon production, and extended social learning already had long histories. Bipedality and stone working predate secure *Homo*. Range expansion, biface manufacture, fire practices, and organic technologies were sustained by *Homo erectus*, Neanderthal-lineage populations, Denisovans, *Homo naledi*, *Homo floresiensis*, and poorly resolved regional forms. We compile the earliest securely dated marker of eight capacities from the cited literature and compare each with the sapiens boundary. Seven of the eight predate both Jebel Irhoud and Omo I; the exception, wooden weapons, is known from a single site where wood happened to survive. Bipedal locomotion precedes the Jebel Irhoud boundary by 4.085 million years, the eight onsets span 4.2 million years, and the median lead is 1.885 million years. At least five other hominin lineages are dated near the boundary. The capacities later attributed to *H. sapiens* were built across an older, multi-lineage hominin population, which the surviving species inherited and narrowed by outlasting, absorbing, or replacing the other lineages.
...
We therefore use "human" in a wider sense than the surviving species. The term here designates a field of lineages: the hominin bodies, techniques, social arrangements, and inherited niches through which *H. sapiens* later became possible. Differences between species remain real, but the modern species is not treated as the origin of capacities it inherited.

Before law, myth, ritual, or explicit doctrine can define persons, organisms must already be able to accumulate tools, food sharing, teaching, memory, and group inheritance. The archaeological and fossil record preserves this earlier assembly in fragments. Sections 2 to 9 review it capacity by capacity, and section 10 quantifies the chronology.
...
The sequence matters. The upright body precedes large brains by millions of years, and the anatomical basis of human history lies first in the feet, pelvis, and hands and in habitat, long before cortical expansion.
...
Stone working is an early, minimal, and durable form of technical inheritance held partly outside the body. One individual learns from another, and each generation leaves cores, flakes, preferred raw materials, activity sites, and failed attempts that structure the learning environment of the next. Technique becomes a social memory stored partly outside any single nervous system.

The archaeological object records the interaction of hand, material, food, landscape, and teaching. A small-brained hominin with a stable flaking tradition already lived in an inherited technical environment.


## 4. Early *Homo* and continental dispersal
...
Fire extends usable hours after sunset, keeps predators away from sleeping groups, softens food, and hardens wooden tools. It provides a place where individuals gather after foraging, adding a second phase to the day that is less occupied by search and movement.

Fire also imposes continuing work. A flame must be fed, guarded, carried, restarted, or found again; fuel must be gathered, embers watched, and the hearth protected from rain. A group that depends on fire takes on a maintenance task that outlasts any single use.

Later societies embedded fire in cosmology, sacrifice, metallurgy, cooking, domestic life, and industry. The earlier fact is simpler: fire gives a mobile group a durable centre, around which sustained attention, teaching, food sharing, and conversation at night become easier.
...
Extended childhood belongs to the same structure. Human infants are costly, slow to mature, and dependent, which is both an anatomical burden and a social opportunity. A long juvenile period gives time to acquire techniques that instinctive maturation alone would not supply. Cooperative breeding, food sharing, and alloparental care allow such expensive learners to survive long enough to transmit a tradition.

Social transmission is visible even where symbols are absent. Teaching produces traditions more stable than independent individual discovery would, whether or not it leaves any mark resembling language. A handaxe industry, a fire practice, a hunting weapon, and a repeated butchery sequence are all records of social transmission.
...
Restricting the word "human" to *Homo sapiens* obscures this structure. Neanderthals made tools, used pigments, cared for injured individuals, lived in harsh climates, and contributed to living genomes. Denisovans are known from genes before any well-described skeleton. *H. naledi* shows that morphology alone cannot explain behavioural capacity, since a small-brained hominin dated close to early *H. sapiens* may still have been capable of complex behaviour. A historical definition of the category has to precede any moral one.
...
The concept of "behavioural modernity" has often been asked to explain too much, because it implies a single threshold after which humans became fully human. The record is patchier. Pigment use appears in different places at different times; ornaments appear, disappear, and reappear; burial and mortuary treatment vary; long-distance exchange is intermittent; and complex technologies can be lost when populations shrink or ecologies change. Capacity depends on demography and social infrastructure as well as on cranial anatomy.

The emergence of *sapiens* is best described as the stabilisation of a package. The species that eventually spread across the planet inherited upright walking, stone working, range expansion, fire, cooperative hunting, and several learned traditions from older hominin populations, and its advantage lay in recombining them across larger, denser, and better-connected populations.


## 9. Single-variable origin accounts

Origin accounts commonly select one real variable and give it priority over all others. Encephalization is real, and brain size changed greatly across hominin evolution, but the chronology rules out a brain-first explanation: upright walking, manipulative hands, stone technology, and range expansion were all established before modern cranial form. Intelligence, as it appears in the record, is distributed across anatomy, group practice, landscape, and artifacts.

Species labels are indispensable and can mislead. They make comparison possible, but they encourage attributing to the last surviving species the histories of extinct ones. Any list of traits assigned to *Homo sapiens* usually contains older elements. The modern species holds and recombines inherited capacities, and treating each capacity as a sapiens invention compresses millions of years of hominin history into the most recent taxonomic label.

Technical origins raise the same problem at a different scale. A tradition is larger than an invention: stone industries, fire practices, hunting systems, and movement ecologies persist because groups reproduce them. Inventions occur, but their survival depends on transmission, so a tool form that lasts for hundreds of thousands of years is a social achievement before it is an individual one.

Replacement was the outcome of a long process. *H. sapiens* became the only surviving hominin species and replaced other groups in many places, but the genetic and archaeological record preserves mixture, overlap, borrowing, coexistence, and local disappearance. The diversity of human lineages narrowed late.

Later cultural categories rest on this older foundation of bodies that carry, hands that make, groups that teach, food that is shared, fire that is maintained, and landscapes remembered across generations.
...
At least five other hominin lineages are dated near the boundary, from the Neanderthal-lineage population at Sima de los Huesos at about 430,000 years through *Homo naledi*, the Denisovans, *Homo luzonensis*, and *Homo floresiensis*. The sapiens threshold therefore stabilised within an already populated field.

The dates are point estimates taken from the cited literature; no new measurements are reported. The computation reports only their stratigraphic relations.


## 11. Conclusion

The pre-sapiens record shows a layered inheritance. Hominins walked and carried; they learned to work stone; groups divided carcasses, maintained fire, moved through remembered landscapes, shaped wood, supported dependent learners, and kept fragile traditions alive across generations.

By the time *Homo sapiens* appears, this field of capacities was already old. Several lineages had built parts of it, leaving fossils, tools, DNA, or only gaps in the record. The modern species appears late in the sequence. It inherited capacities developed in other bodies and environments and became the population in which they were amplified, recombined, and extended after the other human lineages disappeared.

The earlier lineages took part in the same long history of technical, social, and ecological experimentation, and the surviving species is one outcome of it. Its distinctive features are real, and most of the capacities it is credited with are older than the species.


## Reproducibility

The capability onsets, boundary dates, and contemporary lineages are listed with their sources in `simulation/stratigraphy.py`. Running `uv run run_all.py` in `simulation/` computes the lead times, counts, span, and median and writes them to `simulation/output/results.json`, together with a timeline figure in `simulation/output/figures/`.
